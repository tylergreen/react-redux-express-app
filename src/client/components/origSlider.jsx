...
class OrigSlider extends Component {
    constructor() {
        super()
        
        this.handleChangeHor = this.handleChangeHor.bind(this)
        
        this.handleChangeVer = this.handleChangeVer.bind(this)
        
        this.handleChangeNeg = this.handleChangeNeg.bind(this)

        this.handleChangeFlo = this.handleChangeFlo.bind(this)
